    ...
    return (
        <div className='container border border-gray-300 rounded-md p-2 mt-5'>
            <div className="flex justify-between">
                ...
                <div>
                    <NavLink to="/" className="text-gray-500 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium"> 
                    Login</NavLink>
                    <NavLink to="/" className="text-gray-500 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">                    <img className='inline-block' src={userlogo} alt="" />
                    </NavLink>
                </div>
            </div>
        </div>
